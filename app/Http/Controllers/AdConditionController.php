...
class AdConditionController extends Controller
{
    ...
    public function store(Request $request){
        ...
        return redirect('/AdConditions')->with('success', 'Conditions is successfully saved');
    }
    ...
    public function index(){
        ...
        //  return view('lecturer.condition.index', compact('conditions'));
         return view('advisor.condition.index', [
            // 'student_id' => $student,
            'semester' => $semester,
            'generation' => $generation,
    ...
    public function edit($id){
        ...
        return view('advisor.condition.edit', [
            // 'student_id' => $student,
            'semester' => $semester,
            'generation' => $generation,
            'conditions' => $conditions,
    ...
    public function update(Request $request, $id){
        ...
        return redirect('/AdConditions')->with('success', 'Conditions is successfully updated');
    }
    ...
    public function destroy($id){
        ...
        return redirect('/AdConditions')->with('success', 'Conditions is successfully deleted');
    }
}
