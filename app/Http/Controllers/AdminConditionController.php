...
class AdminConditionController extends Controller
{
    ...
    public function store(Request $request){
        ...
        return redirect('/AdminConditions')->with('success', 'Conditions is successfully saved');
    }
    ...
    public function update(Request $request, $id){
        ...
        return redirect('/AdminConditions')->with('success', 'Conditions is successfully updated');
    }
    ...
    public function destroy($id){
        ...
        return redirect('/AdminConditions')->with('success', 'Conditions is successfully deleted');
    }
}
