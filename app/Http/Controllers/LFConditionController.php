...
class LFConditionController extends Controller
{
    ...
    public function createCondition()
    {
        ...
        return view('LF.condition.condition', [
    ...
    public function store(Request $request){
        ...
        return redirect('/LFConditions')->with('success', 'Conditions is successfully saved');
    }
    ...
    public function index(){
        ...
        $generation = Generation::all();
         ...
         return view('LF.condition.index', [
            'semester' => $semester,
            'generation' => $generation,
    ...
    public function update(Request $request, $id){
        ...
        return redirect('/LFConditions')->with('success', 'Conditions is successfully updated');
    }
    ...
    public function destroy($id){
        ...
        return redirect('/LFConditions')->with('success', 'Conditions is successfully deleted');
    }
}
