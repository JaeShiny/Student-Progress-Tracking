...
<head>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="/student_profileAL/{{$bios->student_id}}">ประวัตินักศึกษา</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu scrollable-menu" role="menu">
                                @foreach($gen as $show)
                                <li> <a class="dropdown-item" href="/profileDuringAL1/{{$bios->student_id}}/{{$show->semester}}/{{$show->year}}">{{$show->semester}}/{{$show->year}}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
