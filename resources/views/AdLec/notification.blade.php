...
@section('javascript')
    ...
    $(function(){
        ...
        function getData(semester_value){
          var url ='{{ route('getNotiproblemAL',['student_id' => $s]) }}';
          var value = semester_value;

          if(semester_value != 0){
            url ='{{ route('getNotiproblemAL',['student_id' => $s,'semester' =>'semester_value']) }}';/// same ->  /getNotiproblemA/{student_id}?semester_value=xx
