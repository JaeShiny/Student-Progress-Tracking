...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"><a href="{{ url('#') }}">สถิติผลการเรียน</a></li>
    </ol>
</nav>
...
<ul class="nav nav-tabs" id="myTab" role="tablist" style="background-color:white;">
    ...
    <li class="nav-item">
        <a class="nav-link active" href="/AdLec/chartGradeAL" style="color: #000000;">สถิติผลการเรียน</a>
    </li>
    <li class="nav-item">
