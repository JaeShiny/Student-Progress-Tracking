                 ...
                 <div class="row">
                   ...
                   <div class="col-sm-5">
                         ...
                         <div class="card mb-3" style="max-width: 20rem; background-color:#E6E6FA;box-shadow: 5px 5px 8px 4px rgba(50, 50, 50, .5);""> {{--box-shadow: 5px 5px 8px 4px rgba(50, 50, 50, .5);">--}}
                                 <center> <div class="card-header"><h3>สถิติ</h3></div></center>
                                ...
                                <div class="card-body">
                                  ...
                                  <p class="card-text">
                                        <button type="button" class="btn btn-warning">
                                            <a href="{{ url('subjectStatisticAL2') }}" style="text-decoration-line: none;color: black">จากรายวิชาที่สอน&nbsp;&nbsp;</a>
                                        </button>
                                        </p><br>
                            ...
                            <div class="row no-gutters">
                              ...
                              <div class="col-md-8">
                                <div class="card-body">
                                  ...
                                  <p class="card-text">
                                        <button type="button" class="btn btn-warning">
                                            <a href="/AdLec/chartAttendanceAL" style="text-decoration-line: none;color: black">จากรายชื่อนักศึกษา&nbsp;&nbsp;</a>
                                        </button>
                                        </p><br>
