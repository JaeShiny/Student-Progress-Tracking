   ...
   <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="">การแจ้งเตือนตามวิชา(Lecturer)</a></li>
        </ol>
    </nav>
            ...
            <div class="col-sm-4">
                ...
                <div class="card" style="width: 18rem; box-shadow: 5px 5px 8px 4px rgba(50, 50, 50, .5); ">
                    <div class="card-header" style="background-color:#F75D59;color: white">
                        <b>การแจ้งเตือน</b>
                        <a href="/showNotiAL2/{{$courses->course_id}}" style="text-decoration-line: none">
