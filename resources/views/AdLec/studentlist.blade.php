...
<body>
        <h5 align='right'>
            <button type="button" class="btn btn-outline-warning">
                <a href="/importExportViewAL/{{$course->course_id}}" style="text-decoration-line: none">เพิ่มไฟล์</a>
            </button>
            <button type="button" class="btn btn-outline-warning">
                <a href="/attendanceAL/{{$course->course_id}}/{{$gen->semester}}/{{$gen->year}}"style="text-decoration-line: none">แสดงผลการเข้าเรียน</a>
            </button>
            <button type="button" class="btn btn-outline-warning">
                <a href="/showGradeAL/{{$course->course_id}}/{{$gen->semester}}/{{$gen->year}}"style="text-decoration-line: none">แสดงผลการเรียน</a>
            </button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </h5>
