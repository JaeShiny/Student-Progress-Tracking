...
<body>
        ...
        <h6 align='right'>
            <a href="/problem_createE/{{$bios->student_id}}" style="text-decoration-line: none">
...
@section('javascript')
    ...
    $(function(){
        ...
        function getData(semester_value){
          var url ='{{ route('getStudentproblemE',['student_id' => $s]) }}';
          var value = semester_value;

          if(semester_value != 0){
            url ='{{ route('getStudentproblemE',['student_id' => $s,'semester' =>'semester_value']) }}';/// same ->  /getNotiproblemA/{student_id}?semester_value=xx
