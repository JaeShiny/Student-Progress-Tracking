...
<head>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li> </li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <li class="breadcrumb-item active" aria-current="page"><a href="{{ action('NotificationController@curriNoti') }}">การแจ้งเตือน</a></li>
            <li class="breadcrumb-item active" aria-current="page"><a href="" name="mode">หลักสูตร: {{$curriculum->curriculum_id}}</a></li>
        </ol>
    </nav>
...
@endsection @extends('bar.header(edu)')
