        ...
        <div class="media-body">
            ...
            <center>
                ...
                <a class="btn text-right">
                    ...
                    <span>
                        <a href="/dashboardE/?attendance={{ @$noti['attendance_id'] }}&problem={{ @$noti['problem_id'] }}&grade={{ @$noti['grade_id'] }}&link_target=notification" style="text-decoration-line: none;float: right;color: red">
