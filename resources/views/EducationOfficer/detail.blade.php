...
<div class="card-content">
    ...
    <hr style="margin-top: 0%">
      ...
      &nbsp;&nbsp;&nbsp;  <a href="/edusurvey/{{$survey->id}}/edit">แก้ไขหัวข้อแบบสอบถาม</a> | <a href="/edusurvey/answers/{{$survey->id}}">ดูผลการตอบแบบสำรวจ</a> <a href="/edusurvey/{{$survey->id}}/delete" style="float:right; text-decoration: none" class="modal-trigger red-text">ลบแบบสำรวจ &nbsp; &nbsp;</a>
    <!-- Modal Structure -->
    <!-- TODO Fix the Delete aspect -->
        ...
        <div class="modal-content">
            <div class="container">
                <div class="row">
                    ...
                    <p>Do you wish to delete this survey called "{{ $survey->title }}"?</p>
                    <div class="modal-footer">
                        <a href="/edusurvey/{{ $survey->id }}/delete" class=" modal-action waves-effect waves-light btn-flat red-text">Yep yep!</a>
                        <a class=" modal-action modal-close waves-effect waves-light green white-text btn">No, stop!</a>
                    </div>
                </div>
            </div>
