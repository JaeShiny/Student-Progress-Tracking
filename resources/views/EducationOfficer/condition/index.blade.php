  ...
  <table class="table table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="{{ route('EduConditions.edit',$con->id)}}" class="btn btn-primary">Edit</a></td>
            <td>
                <form action="{{ route('EduConditions.destroy', $con->id)}}" method="post">
                  @csrf
                  @method('DELETE')
