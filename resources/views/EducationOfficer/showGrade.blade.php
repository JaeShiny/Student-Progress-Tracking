...
<body>
        <ul class="nav nav-tabs" id="myTab" role="tablist" style="background-color:white;">
                <li class="nav-item">
                    <a class="nav-link" href="/attendanceE/{{$s}}" style="color: #000000;">การเข้าเรียน</a>
                </li>
                <li class="nav-item">
            ...
            <tbody>
                <tr>
                  ...
                  <td><center>{{$show_student->course_id}}</center></td>
                    <td>
                        <a href="/profileDuringE/{{$show_student->student_id}}" style="color: black;text-decoration-line: none">
