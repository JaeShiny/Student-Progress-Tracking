                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <br>
                                <br>
                                <div class="card"style="background-color:#E6E6E6;margin-top: 1%;box-shadow: 5px 5px 8px 4px rgba(50, 50, 50, .5);">
                                    <div class="card-header" style="background-color:#E6E6FA">
                                            <span class="card-title"> <h4> &nbsp; {{ $survey->title }} </h4> <h6>&nbsp;&nbsp;&nbsp;รายละเอียด : {{ $survey->description }}</h6></span>
                                    </div>
                                    <div class="card-body">
                                        <blockquote class="blockquote mb-0">
                                            <form method="POST" action="/survey/{{ $survey->id }}/questions" id="boolean">
                                                                ...
                                                                <li style="box-shadow:none;">
                                                                    ...
                                                                    <div class="collapsible-body">
                                                                        <div style="margin:5px; padding:10px;">
                                                                            ...
                                                                            @elseif($question->question_type === 'radio')
                                                                            @foreach($question->choice as $show_choice)
                                                                            <input name="radio" type="radio" value="{{$show_choice->id}}">
                                                                            <label>{{$show_choice->choice_name}}</label><br>
                                                                            @endforeach
                                                                            </p>

                                                                            @elseif($question->question_type === 'checkbox')
                                                                            @foreach($question->choice as $show_choice)
                                                                            <input type="checkbox" value="{{$show_choice->id}}">
                                                                            <label>{{$show_choice->choice_name}}</label><br>
