...
<div class="container">
    ...
    <center>
        <table class="table table-striped" id="grade" style="box-shadow: 5px 5px 8px 4px rgba(50, 50, 50, .5);">
          ...
          <tbody  th style="background-color: white">
...
@section('javascript')
    ...
    $(function(){
        ...
        function getData(semester_value){
          var url ='{{ route('getChartA',['student_id' => $stu]) }}';
          var value = semester_value;

          if(semester_value != 0){
            url ='{{ route('getChartA',['student_id' => $stu,'s' =>'semester_value']) }}';/// same ->  /getNotiproblemA/{student_id}?semester_value=xx
