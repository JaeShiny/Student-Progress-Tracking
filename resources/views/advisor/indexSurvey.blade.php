...
<body>
    ...
    <body>
        ...
        <div class="bg-text">
            ...
            <h6>ADVISOR</h6>
            <div class="buttontwo">
            <button type="submit" class="btn btn-primary" > <a class="nav-link" href="/survey/advisor/advisor" style="color: #FFFFFF">ดูแบบสอบถาม</a></button>
           <button type="submit" class="btn btn-primary" > <a class="nav-link" href="/survey/advisornew" style="color: #FFFFFF">สร้างแบบสอบถาม</a></button>
            </div>
        </div>
