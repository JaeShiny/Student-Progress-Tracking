...
<ul class="nav nav-tabs" id="myTab" role="tablist" style="background-color:white;">
    <li class="nav-item">
        <a class="nav-link active" href="/importExportView/{{$course->course_id}}" style="color: #000000;">การเข้าเรียน (ทฤษฎี)</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="/importExportView2/{{$course->course_id}}" style="color: #000000;">การเข้าเรียน (Lab)</a>
    </li>
    <li class="nav-item">
...
<div class="row">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <div class="col">
        <div class="list-group" id="list-tab" role="tablist">
            ...
            <a class="list-group-item list-group-item-action active" href="/importExportView/{{$course->course_id}}"><b>เพิ่มการเข้าเรียน (ทฤษฎี)</b></a>
            <a class="list-group-item list-group-item-action" href="/importExportView2/{{$course->course_id}}"><b>เพิ่มการเข้าเรียน (Lab)</b></a>
