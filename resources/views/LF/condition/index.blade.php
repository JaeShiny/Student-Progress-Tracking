  ...
  <table class="table table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="{{ route('LFConditions.edit',$con->id)}}" class="btn btn-primary">Edit</a></td>
            <td>
                <form action="{{ route('LFConditions.destroy', $con->id)}}" method="post">
                  @csrf
                  @method('DELETE')
