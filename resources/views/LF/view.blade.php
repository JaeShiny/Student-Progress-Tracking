...
<div class="card-content">
    ...
    <hr style="margin-top: 0%">
      ...
      &nbsp; &nbsp; &nbsp; <a href='/lfsurvey/{{$survey->id}}'>เพิ่มคำถาม</a> | <a href="/lfsurvey/{{$survey->id}}/edit">แก้ไขหัวข้อแบบสำรวจ</a> | <a href="/lfsurvey/answers/{{$survey->id}}">ดูผลการตอบแบบสำรวจ</a> <a href="/lfsurvey/{{$survey->id}}/delete" style="float:right; text-decoration: none" class="modal-trigger red-text">ลบแบบสำรวจ &nbsp; &nbsp;</a>
    <!-- Modal Structure -->
          ...
          <div class="row d-flex mb-5 contact-info">
            ...
            <div class="col-md-7">
                ...
                <div class="card-body">
                    ...
                    <div class="divider" style="margin:20px 0px;"></div>--}}
                    <h5 class="card-title">
          {!! Form::open(array('action'=>array('student\AnswerController@storeLF', $survey->id))) !!}
          @forelse ($survey->questions as $key=>$question)
