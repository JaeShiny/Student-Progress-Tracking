...
<h5 align='right'>
    ...
    <div class="container">
        <form action="/student_searchLF/{{$course->course_id}}/{{$gen->semester}}/{{$gen->year}}" method="get">
            ...
            <tbody>
              ...
              <tr>
                <td scope="row" width="10">
                    <a href="{{route('profileLF',$student->student_id)}}">
                        {{$student->student_id}}
                    </a>
                </td>
                ...
                <td width="10">
                    <a href="/chartStudentLF/{{$student->student_id}}">
                ...
                <td width="10">
                <a href="/studentproblemLF/{{$student->student_id}}/1/{{$gen->year}}">
                        <center><img src="{{ URL::asset("../img/feedback.png") }}" width="25" title="พฤติกรรม/ปัญหา"></center>
                    </a>
                </td>
                <td width="10">
                    <a href="/problem_createLF/{{$student->student_id}}">
