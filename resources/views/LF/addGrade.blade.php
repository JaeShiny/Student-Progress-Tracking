...
<head>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page"><a href="/importExportGradeLF/{{$course->course_id}}">เพิ่มผลการเรียน</a></li>
        </ol>
    </nav>
    ...
    <div class="row mx-lg-n5">
     ...
     <div class="container">
        <div class="card bg-light mt-3">
            ...
            <div class="card-body">
                <form action="/importGradeLF/{{$course->course_id}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="container">
                        <div class="form-group">
                            ...
                            <a class="btn btn-warning" href="/exportGradeLF/{{$course->course_id}}">Export ผลการเรียน</a>
                        </div>
                        <!-- Modal -->
