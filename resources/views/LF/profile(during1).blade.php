...
<head>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="/student_profileLF/{{$bios->student_id}}">ประวัตินักศึกษา</a></li>
