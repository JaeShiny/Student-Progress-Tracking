...
<br>
<h6 align='right'>
    <a href="/StudentConditions/create">
  ...
  <table class="table table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="{{ route('StudentConditions.edit',$con->id)}}" class="btn btn-primary">Edit</a></td>
            <td>
                <form action="{{ route('StudentConditions.destroy', $con->id)}}" method="post">
                  @csrf
                  @method('DELETE')
