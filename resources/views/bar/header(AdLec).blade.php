...
<head>
    ...
    <nav class="nav" style="background-color: #1D5287;">
        ...
        <a class="nav-link" href="{{ url('indexChart') }}" style="color: #FFFFFF">สถิติ</a>
                      ...
                      <div class="dropdown">
                            ...
                            <ul class="dropdown-menu scrollable-menu" role="menu"  >
                                  @foreach($semester as $show)
                                        ...
                                        <li> <a class="dropdown-item" href="/AdLec/ALStudent/{{$show->semester}}/{{$show->year}}">ภาคเรียน: {{$show->semester}}/{{$show->year}}</a>  </li>
