...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            'driver' => 'mysql',
            'host' => env('DB_HOST', 'studentprogress.ckkh3d8cwhst.ap-southeast-1.rds.amazonaws.com'),
        ...
        'mysql2' => [
            'driver' => 'mysql',
            'host' => env('DB_HOST_2','ec2-54-169-137-167.ap-southeast-1.compute.amazonaws.com'),
        ...
        'mysql3' => [
            'driver' => 'mysql',
            'host' => env('DB_HOST_3','ec2-13-250-32-193.ap-southeast-1.compute.amazonaws.com'),
        ...
        'mysql4' => [
            'driver' => 'mysql',
            'host' => env('DB_HOST_4','ec2-54-169-251-141.ap-southeast-1.compute.amazonaws.com'),
