...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'mysql2' => [
            'driver' => 'mysql',
            'host' => env('DB_HOST_2','ec2-52-221-180-31.ap-southeast-1.compute.amazonaws.com'),
        ...
        'mysql3' => [
            'driver' => 'mysql',
            'host' => env('DB_HOST_3','ec2-54-169-202-85.ap-southeast-1.compute.amazonaws.com'),
        ...
        'mysql4' => [
            'driver' => 'mysql',
            'host' => env('DB_HOST_4','ec2-13-250-44-116.ap-southeast-1.compute.amazonaws.com'),
